...
ALTER TABLE Temporada MODIFY COLUMN ID NOT NULL;
...
ALTER TABLE AlmacenaTemporada MODIFY COLUMN ID_Ep NOT NULL;
...
ALTER TABLE Temporada MODIFY COLUMN ID_Tmp NOT NULL;
